...
static void sam9_l9260_request_gpio(void)
{
...
{
	at91_set_gpio_value(SAM9_L9260_SPI_CS_PIN, 0);
}

void spi_cs_deactivate(struct spi_slave *slave)
{
	at91_set_gpio_value(SAM9_L9260_SPI_CS_PIN, 1);
}
#endif
...
int board_init(void)
{
	...
	/* Configure SPI */
	at91_spi0_hw_init(SAM9_L9260_SPI_MASK);
